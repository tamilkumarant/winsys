	...
	@section('content')
			...
			<div class="col-md-6 chart">
				<a href='javascript:;' class="expandBtn">test</a>
				<div id="chartCnt1">
	...
	<script>
		...
		$(function(){	
			...
			$(".expandBtn").on("click", function(){
				if($(this).hasClass("expendOpen1")){
					$(this).removeClass("expendOpen1");
					$(this).closest(".chart").addClass("col-md-6").removeClass("col-md-12");
					call1();
				} else {
					$(this).addClass("expendOpen1");
					$(this).closest(".chart").removeClass("col-md-6").addClass("col-md-12 expendOpen1");
					call1();
				}
			});
