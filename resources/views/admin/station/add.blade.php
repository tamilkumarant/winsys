								...
								<div class="col-md-4">						  
									...
									<div class="box-body">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="pub_id" name="pub_id" placeholder="PUB ID" required/>
										</div>
									</div>				  
									<div class="box-body">
										<div class="form-group">
									...
									<div class="box-body">
										<div class="form-group">
											...
											<input type="number" class="form-control offset_o" id="offset_o" name="offset_o" placeholder="Station Offset" />
										</div>
									</div>		  
									<div class="box-body">
										<div class="form-group">
								...
								<div class="col-md-4">				
									<div class="box-body">
										<div class="form-group">
											...
											<input type="number" class="form-control copelevel" id="copelevel" name="copelevel" placeholder="Station ID" required />
										</div>
									</div>				  
									<div class="box-body">
										<div class="form-group">
											<label for="invertlevel">Station Invert Level</label><span class="required_star">*</span>
											<input type="number" class="form-control invertlevel" id="invertlevel" name="invertlevel" placeholder="Station Name" required onblur="setOffset()" />
										</div>
									</div>			  
									<div class="box-body displaynone">
										<div class="form-group">
									...
									<div class="box-body">
										<div class="form-group">
											...
											<input type="number" class="form-control operationlevel" id="operationlevel" name="operationlevel" placeholder="Station operation level" required value="" onblur="setOffset()" />
										</div>
									</div>		  
									<div class="box-body displaynone">
										<div class="form-group">
									...
									<div class="box-body displaynone">
										<div class="form-group">
											...
											<input type="number" class="form-control alarmlevel" id="alarmlevel" name="alarmlevel" placeholder="Alarmlevel" value=""  />
										</div>
									</div>	
									...
									<div class="box-body">
										<div class="form-group">
											...
											<input type="number" class="form-control b1" id="b1" name="b1" placeholder="B1" required value=""  />
										</div>
									</div>		  
									<div class="box-body">
										<div class="form-group">
											<label for="b2">B2</label><span class="required_star">*</span>
											<input type="number" class="form-control b2" id="b2" name="b2" placeholder="B2" required value=""  />
										</div>
									</div>		  
									<div class="box-body">
										<div class="form-group">
											<label for="b3">B3</label><span class="required_star">*</span>
											<input type="number" class="form-control b3" id="b3" name="b3" placeholder="B3" required value=""  />
										</div>
									</div>		  
									<div class="box-body">
										<div class="form-group">
											<label for="b4">B4</label><span class="required_star">*</span>
											<input type="number" class="form-control b4" id="b4" name="b4" placeholder="B4" required value=""  />
										</div>
									</div>		  
									<div class="box-body">
										<div class="form-group">
											<label for="b5">B5</label><span class="required_star">*</span>
											<input type="number" class="form-control b5" id="b5" name="b5" placeholder="B5" required value=""  />
										</div>
									</div>	 
								</div>
								...
								<div class="col-md-4">			  
									<div class="box-body">
										<div class="form-group">
											...
											<input type="number" class="form-control" id="h1" name="h1" placeholder="H1" required value=""  />
										</div>
									</div>		  
									<div class="box-body">
										<div class="form-group">
											<label for="h2">H2</label><span class="required_star">*</span>
											<input type="number" class="form-control" id="h2" name="h2" placeholder="H2" required value=""  />
										</div>
									</div>		  
									<div class="box-body">
										<div class="form-group">
											<label for="h3">H3</label><span class="required_star">*</span>
											<input type="number" class="form-control" id="h3" name="h3" placeholder="H3" required value=""  />
										</div>
									</div>		  
									<div class="box-body">
										<div class="form-group">
											<label for="h4">H4</label><span class="required_star">*</span>
											<input type="number" class="form-control" id="h4" name="h4" placeholder="H4" required value=""  />
										</div>
									</div>		  
									<div class="box-body">
										<div class="form-group">
											<label for="h5">H5</label><span class="required_star">*</span>
											<input type="number" class="form-control" id="h5" name="h5" placeholder="H5" required value=""  />
										</div>
									</div>		  
									<div class="box-body">
										<div class="form-group">
											<label for="w1">W1</label><span class="required_star">*</span>
											<input type="number" class="form-control w1" id="w1" name="w1" placeholder="W1" required value=""  />
										</div>
									</div>		  
									<div class="box-body">
										<div class="form-group">
											<label for="w2">W2</label><span class="required_star">*</span>
											<input type="number" class="form-control w2" id="w2" name="w2" placeholder="W2" required value=""  />
										</div>
									</div>		   
									<div class="box-body">
										<div class="form-group">
											<label for="w3">W3</label><span class="required_star">*</span>
											<input type="number" class="form-control w3" id="w3" name="w3" placeholder="W3" required value=""  />
										</div>
									</div>
									<div class="box-body">
										<div class="form-group">
											<label for="w4">W4</label><span class="required_star">*</span>
											<input type="number" class="form-control w4" id="w4" name="w4" placeholder="W4" required value=""  />
										</div>
									</div>	  
									<div class="box-body">
										<div class="form-group">
											<label for="w5">W5</label><span class="required_star">*</span>
											<input type="number" class="form-control w5" id="w5" name="w5" placeholder="W5" required value=""  />
										</div>
									</div>	 
								</div>
...
<script>
	...
	function setOffset(){ 
		...
		// console.log(copelevel);console.log(invertlevel);console.log((copelevel-invertlevel));
