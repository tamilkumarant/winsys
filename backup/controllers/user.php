	...
	?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="user_registration.php"><i class="fa fa-plus"></i> Add new user</a></li>
		  </ol>
        </section>
        ...
        <section class="content">
          ...
          <div class="box">
                ...
                <div class="box-body">
					<?php
						require "../code_behind/user_display_list.php"; // common header
					?>
				</div><!-- /.box-body -->
              </div><!-- /.box -->
	...
	<!-- delete user -->
	<script src="../jscript/user_delete.js"></script>
  </body>
</html>